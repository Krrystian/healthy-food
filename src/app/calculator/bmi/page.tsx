          ...
          <div className='flex flex-row justify-between'>
            <div className='w-1/2 pr-4'>
              ...
              <p>Wskaźnik BMI to skrót od angielskiego "Body Mass Index". Informuje nas o stosunku naszej masy ciała (wagi) do wzrostu.
                ...
                Wzór na wyznaczenie BMI stworzył Adolphe Quetelet już w 1832 roku i wygląda następująco:<span className="block text-center font-bold my-2">BMI = waga / (wzrost_w_metrach ^ 2)</span>
                Normy BMI:<br/>
              </p>
