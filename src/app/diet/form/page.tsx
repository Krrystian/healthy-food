                            ...
                            <tr className='py-4'>
                                ...
                                <td>
                                    <select {...register('habits', { required: true })} className='w-full p-2 border border-gray-300 rounded'>
                                        <option value="nic" className='text-base font-sans'>Nie</option>
                                        <option value="podjadanie" className='text-base font-sans'>Podjadanie między posiłkami</option>
                                        <option value="nieregularnie" className='text-base font-sans'>Nieregularne posiłki</option>
                                        <option value="malo_wody" className='text-base font-sans'>Picie za mało wody</option>
                                        <option value="duze_porcje" className='text-base font-sans'>Jedzenie za dużych porcji</option>                                
                                    </select>
                                </td>
                            </tr>
                            <tr className='py-4'>
